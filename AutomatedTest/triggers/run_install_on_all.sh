#!/bin/bash
# ==============================================================================
# Compile latest debug APK and install on all connected devices
# ==============================================================================
set -e
...
for DEVICE in $DEVICES; do
  ...
  echo "🧹 Clearing app data (ensuring clean state)..."
...
echo "🎉 Success! Installed and configured on all connected devices."
